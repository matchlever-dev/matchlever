...
import { ABOUT_MATCHLEVER } from "@/lib/marketing/about-matchlever";
...
export const metadata: Metadata = {
  title: "About MatchLever · Arise Solutions",
  description:
    "About MatchLever — faster, smarter matching for vetted talent and hiring teams.",
};

export default function AboutMatchLeverPage() {
  return (
    <div className="min-h-[100svh] bg-[#F7F6F3] text-[#2A2D34]">
      ...
      <main className="mx-auto max-w-3xl px-5 py-10 sm:px-8 sm:py-14">
        ...
        <h1 className="mt-3 font-display text-3xl font-semibold tracking-tight text-[#2B5B84] sm:text-4xl">
          {ABOUT_MATCHLEVER.title}
        </h1>

        <div className="mt-10 space-y-10">
          {ABOUT_MATCHLEVER.sections.map((section) => (
