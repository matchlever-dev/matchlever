...
export const metadata: Metadata = {
  title: "MatchLever · Connect Top Talent with Best Jobs",
  description:
    "Connect top talent with the best jobs. Hire vetted professionals or apply as talent on MatchLever.",
};

export default async function HomePage() {
  const [{ heroTaglines }, featuredTalent] = await Promise.all([
    getSiteCopy(),
    getFeaturedTalent(),
  ]);
