/** Human-readable Talent Terms for in-app display. Authoritative copy is the PDF. */

export const TALENT_TOS_SECTIONS = [
  {
    heading: "1. Acceptance of Terms & Services Overview",
    body: `By completing the Talent Onboarding Wizard, you agree to be bound by these Terms. MatchLever operates as a dual-sided marketplace designed to generate precise matches with zero search fatigue. While the platform charges hiring organizations fees for interviewing talent, use of the platform is strictly governed by the rules outlined below.`,
  },
  {
  ...
  {
    heading: "4. Talent Profile, AI Sanitization, & Anonymity",
    intro:
    ...
    bullets: [
      ...
      'Superpower Taglines: To prevent vague or boastful self-reporting, talent cannot enter freeform summary text. Instead, the AI evaluates your verified resume data and technical stack to generate three high-impact, metrics-driven "Superpower Tagline" options. You are required to select one of these three options during onboarding.',
    ],
  },
  {
    ...
    bullets: [
      ...
      "AI Authenticity Scoring: MatchLever runs a Multi-Signal AI Authenticity Scoring Matrix on all reference LinkedIn profiles. This system checks for bot-farm patterns, evaluates profile completeness against talent claims, and checks connection counts and account maturity.",
  ...
  },
  {
    ...
    bullets: [
      ...
      'Profile Unlocking: Your true identity remains completely anonymous on your talent card. Your contact email, real full name, original resume URL, and LinkedIn URL are only revealed (status changed to "UNLOCKED") after an employer accepts your match and pays a non-refundable $199 fee to proceed to the interview stage.',
    ],
  },
  {
    heading: "7. Data Privacy & Talent Controls",
    bullets: [
      'On Hold / Snoozed Status: If you are no longer actively looking, you can use the "On Hold (Snoozed)" toggle switch on your Talent Dashboard. This immediately updates your database status and guarantees your profile is entirely hidden from all employer searches.',
